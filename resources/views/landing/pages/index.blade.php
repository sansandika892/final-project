				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom kitchen garage">
					<div class="grid">
						<figure class="effect-apollo">
							...
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{('/storage/landing/assets/img/portfolio/1.jpg')}}"></a>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom garage">
					<div class="grid">
						<figure class="effect-apollo">
							...
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{('/storage/landing/assets/img/portfolio/2.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix basement garage">
					<div class="grid">
						<figure class="effect-apollo">
							...
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{('/storage/landing/assets/img/portfolio/7.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
